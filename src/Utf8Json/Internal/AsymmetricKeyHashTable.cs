...
//    internal abstract class AsymmetricKeyHashTable<TKey1, TKey2, TValue>
//    {
//        Entry[] buckets;
...
//        public AsymmetricKeyHashTable(int capacity, float loadFactor)
//        {
...
//        protected abstract int GetHashCode(TKey1 key1);
//        protected abstract int GetHashCode(TKey2 key2);
//        protected abstract bool Equals(TKey1 x, TKey1 y); // when used rehash
//        protected abstract bool Equals(TKey1 x, TKey2 y); // when used get
...
//    internal sealed class ByteArrayKeyHashTable<TValue> : AsymmetricKeyHashTable<byte[], ArraySegment<byte>, TValue>
//    {
//        static readonly bool Is32Bit = (IntPtr.Size == 4);

//        protected override bool Equals(byte[] x, byte[] y)
//        {
...
//        protected override bool Equals(byte[] x, ArraySegment<byte> y)
//        {
//            throw new NotImplementedException();
//        }

//        protected override int GetHashCode(byte[] key1)
//        {
//            return GetHashCode(new ArraySegment<byte>(key1, 0, key1.Length));
//        }

//        protected override int GetHashCode(ArraySegment<byte> key2)
//        {
//            unchecked
//            {
//                if (Is32Bit)
