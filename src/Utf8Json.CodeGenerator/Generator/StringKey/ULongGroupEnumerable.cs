...
{
    public struct ULongGroupEnumerable : IEnumerable<ReadOnlyMemory<ValueTuple<byte[], MemberSerializationInfo>>>
    {
        ...
        public ULongGroupEnumerable(ReadOnlyMemory<(byte[], MemberSerializationInfo)> source, int startIndexOfUlong)
        {
            this.source = source;
